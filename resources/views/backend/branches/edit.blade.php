...
@section('meta_title',__('Edit Our Branches'))

@section('page_name',__('Edit Our Branches'))

@section('page_description',__('Edit Our Branches'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Edit Our Branches') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('branches.update',encrypt($board->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
