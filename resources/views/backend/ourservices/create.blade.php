...
@section('meta_title',__('Add Add Our Services'))

@section('page_name',__('Add Add Our Services'))

@section('page_description',__('Add Add Our Services'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Add Our Services') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
