...
@section('meta_description','CarryCode Technology is a futuristic IT solutions company in India, specializing in custom web & mobile app development, SaaS, digital marketing, and Google Business Profile services.')
@section('content')
<main class="main">
